<template>
  <AppBar></AppBar>
  <!-- <p v-if="data" v-for="anime in data.data">
    {{ anime.url }}
    <img v-bind:src="anime.images.jpg.image_url" alt="" height="100">
  </p> -->
  <div class="main">
...
async function fetchData() {
  ...
  data.value = await fetch("http://127.0.0.1:5000/api/getAnimes").then((response)=>response.json());
}
